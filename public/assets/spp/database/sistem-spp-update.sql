...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2021 at 12:35 AM
...
('HT001', '1', '2021-07-28', 'warjiyanto', 500000, 400000);
...
('10700295', 'SMK 6 KOTA BEKASI', 'Jl. Angker No.111', 'Surabaya', 'Jawa Timur ', 'false', 'ahmad syaikhu. S.Kom', 'SB-Mid-server-MGrqH0etTuGjr6n5d432VINL', 'ANISA ANJARSARI ', 'SB-Mid-client-HoGPUS9TvPG38_3Z', 'https://app.sandbox.midtrans.com/snap/snap.js', 'SHOLIHATUL FAHMI', 'boedoet.png', 'bekasi.png');
...
(412, '7612641827', '783585391', 'Ahmad Baihaqi', 'L', 'Islam', 9, 'Lulus', '', NULL, '', 'Sudin Samsudin', 'Alamatnya', '092507235', 500000),
...
--
ALTER TABLE `tagihan_bebas`
  MODIFY `idTagihanBebas` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2252;
...
--
ALTER TABLE `tagihan_bulanan`
  MODIFY `idTagihanBulanan` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
